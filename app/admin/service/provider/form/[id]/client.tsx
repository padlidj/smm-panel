...
const OPS: { key: string; label: string; req: [string, string][]; resp: [string, string][]; sv?: string[]; extra?: 'service' }[] = [
  ...
  { key: 'order_config', label: 'Pesanan', req: [['action', 'Aksi'], ['provider_id', 'ID'], ['provider_key', 'Kunci'], ['provider_secret', 'Rahasia'], ['service', 'ID Layanan'], ['target', 'Target'], ['quantity', 'Jumlah'], ['custom_comments', 'Custom Comments']], resp: [['order_id', 'ID Pesanan']] },
